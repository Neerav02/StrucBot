    ...
    >
      <div className="max-w-md w-full space-y-8 p-8 bg-gray-900 rounded-2xl shadow-2xl border border-gray-800">
        <div className="text-center">
          ...
          <h2 className="mt-6 text-3xl font-bold text-white">Sign in to Strucbot</h2>
        </div>
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="space-y-4 rounded-md shadow-sm">
            <input
              type="text"
              required
              className="w-full px-4 py-3 border border-gray-700 rounded-lg bg-gray-800 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-all"
